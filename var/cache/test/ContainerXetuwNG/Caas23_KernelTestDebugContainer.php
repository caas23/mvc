 ...
 */
class Caas23_KernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Caas23\\Controller\\DiceGameController' => 'getDiceGameControllerService',
            'Caas23\\Controller\\Kmom01ControllerApi' => 'getKmom01ControllerApiService',
            'Caas23\\Controller\\Kmom01ControllerTwig' => 'getKmom01ControllerTwigService',
            'Caas23\\Controller\\Kmom02ControllerApi' => 'getKmom02ControllerApiService',
            'Caas23\\Controller\\Kmom02ControllerApiJoker' => 'getKmom02ControllerApiJokerService',
            'Caas23\\Controller\\Kmom02ControllerCard' => 'getKmom02ControllerCardService',
            'Caas23\\Controller\\Kmom02ControllerCardJoker' => 'getKmom02ControllerCardJokerService',
            'Caas23\\Controller\\Kmom03Controller' => 'getKmom03ControllerService',
            'Caas23\\Controller\\Kmom05Controller' => 'getKmom05ControllerService',
            'Caas23\\Controller\\Kmom06Controller' => 'getKmom06ControllerService',
            'Caas23\\Controller\\Kmom10Controller' => 'getKmom10ControllerService',
            'Caas23\\Controller\\Kmom10ControllerApi' => 'getKmom10ControllerApiService',
            'Caas23\\Controller\\SessionController' => 'getSessionControllerService',
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostF35c66a', static fn () => \EntityManagerGhostF35c66a::createLazyGhost(static fn ($proxy) => self::getDoctrine_Orm_DefaultEntityManagerService($container, $proxy)));
        }
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriverService($container)
    {
        ...
        $b = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/src/Entity')], true));

        $a->addDriver($b, 'App\\Entity');
        $a->addDriver($b, 'Caas23\\Entity');
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['argument_resolver.request_payload'] = $container->createProxy('RequestPayloadValueResolverGhostA17062c', static fn () => \RequestPayloadValueResolverGhostA17062c::createLazyGhost(static fn ($proxy) => self::getArgumentResolver_RequestPayloadService($container, $proxy)));
        }
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fPaPXraxjD', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.asset_mapper.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0REWm-An0h', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('o1tplrVqCi', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uCSSShzxZz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uCsLMzN+CI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OmH7cLELc6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7czeKzjwFY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('daJZNSjPmW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xqvJ0Y+Ads', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.webpack_encore.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hK0hzm2abI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }

    /**
     * Gets the private 'chartjs.twig_extension' shared service.
     *
     * @return \Symfony\UX\Chartjs\Twig\ChartExtension
     */
    protected static function getChartjs_TwigExtensionService($container)
    {
        $a = ($container->privates['stimulus.helper'] ?? self::getStimulus_HelperService($container));

        if (isset($container->privates['chartjs.twig_extension'])) {
            return $container->privates['chartjs.twig_extension'];
        }

        return $container->privates['chartjs.twig_extension'] = new \Symfony\UX\Chartjs\Twig\ChartExtension($a);
    }
    ...
    {
        return $container->privates['data_collector.logger'] = new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector(($container->privates['monolog.logger.profiler'] ?? self::getMonolog_Logger_ProfilerService($container)), ($container->targetDir.''.'/Caas23_KernelTestDebugContainer'), ($container->services['.virtual_request_stack'] ?? self::get_VirtualRequestStackService($container)));
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['Caas23\\Kernel', 'Caas23\\Controller\\DiceGameController', 'Caas23\\Controller\\Kmom01ControllerApi', 'Caas23\\Controller\\Kmom01ControllerTwig', 'Caas23\\Controller\\Kmom02ControllerApi', 'Caas23\\Controller\\Kmom02ControllerApiJoker', 'Caas23\\Controller\\Kmom02ControllerCard', 'Caas23\\Controller\\Kmom02ControllerCardJoker', 'Caas23\\Controller\\Kmom03Controller', 'Caas23\\Controller\\Kmom05Controller', 'Caas23\\Controller\\Kmom06Controller', 'Caas23\\Controller\\Kmom10Controller', 'Caas23\\Controller\\Kmom10ControllerApi', 'Caas23\\Controller\\SessionController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'Caas23\\Repository\\DeceasedCovidRepository' => ['privates', 'Caas23\\Repository\\DeceasedCovidRepository', 'getDeceasedCovidRepositoryService', true],
            'Caas23\\Repository\\DeceasedGeneralRepository' => ['privates', 'Caas23\\Repository\\DeceasedGeneralRepository', 'getDeceasedGeneralRepositoryService', true],
            'Caas23\\Repository\\EnergyPetroRepository' => ['privates', 'Caas23\\Repository\\EnergyPetroRepository', 'getEnergyPetroRepositoryService', true],
            'Caas23\\Repository\\EnergySupplyRepository' => ['privates', 'Caas23\\Repository\\EnergySupplyRepository', 'getEnergySupplyRepositoryService', true],
            'Caas23\\Repository\\EnergyUseRepository' => ['privates', 'Caas23\\Repository\\EnergyUseRepository', 'getEnergyUseRepositoryService', true],
            'Caas23\\Repository\\LibraryRepository' => ['privates', 'Caas23\\Repository\\LibraryRepository', 'getLibraryRepositoryService', true],
        ], [
    ...
    {
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/src/Entity')], true);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setEntityNamespaces(['App' => 'App\\Entity', 'Caas23' => 'Caas23\\Entity']);
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(($container->privates['chartjs.twig_extension'] ?? self::getChartjs_TwigExtensionService($container)));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Caas23_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Caas23_KernelTestDebugContainer',
