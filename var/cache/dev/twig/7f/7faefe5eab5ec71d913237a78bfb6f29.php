...
class __TwigTemplate_a71e38d1b78197b24503b3bf55b3825a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <ul>
        <li>";
        // line 12
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["diceString"]) || array_key_exists("diceString", $context) ? $context["diceString"] : (function () { throw new RuntimeError('Variable "diceString" does not exist.', 12, $this->source); })()), "html", null, true);
        yield "</li>
    </ul>
</div>
";
...
{% endblock %}", "pig/test/roll.html.twig", "/home/caas23/dbwebb-kurser/mvc/me/report/templates/pig/test/roll.html.twig");
    }
}
